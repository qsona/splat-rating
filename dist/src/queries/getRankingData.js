...
const getRankingData = async (user) => {
    ...
    for (var i = 0; i < rules_1.SPLAT_RULES_NAME_MAP.length; i++) {
        const rule = rules_1.SPLAT_RULES_NAME_MAP[i];
...
//# sourceMappingURL=getRankingData.js.map